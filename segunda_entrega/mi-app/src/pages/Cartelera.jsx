...
export default function Cartelera() {
    ...
    // ✅ Guardar la película con la ruta de imagen corregida
    const guardarPelicula = (peli) => {
        const peliculaConRuta = {
            ...peli,
            imagen: peli.imagen.startsWith("/imagenes/")
                ? peli.imagen
                : `/imagenes/${peli.imagen}`,
        };
        localStorage.setItem("peliculaSeleccionada", JSON.stringify(peliculaConRuta));
